...
var Enemy = function (posX, posY, direction, velocity) {
    ...
    this.x = posX * TILE_WIDTH;
    this.y = posY * TILE_HEIGHT + ENEMY_OFFSET;
    this.dir = direction;
    this.spd = velocity;
}
...
var PowerUp = function (posX, posY, type, value) {
    this.x = posX * TILE_WIDTH;
    var tmpY = posY * TILE_HEIGHT;
    switch (type) {
    case "Heart":
        this.sprite = 'images/Heart.png';
        this.y = tmpY + HEART_OFFSET;
        break;
    case "Gem_Blue":
        this.sprite = 'images/Gem Blue.png';
        this.y = tmpY + GEM_OFFSET;
        break;
    case "Gem_Green":
...
var Player = function (posX, posY, startingHealth, startingScore) {
    ...
    this.x = posX * TILE_WIDTH + PLAYER_OFFSET_H;
    this.y = posY * TILE_HEIGHT + PLAYER_OFFSET_V;
    this.comm = "neutral";
}
...
var enemyA = new Enemy(1, 2, "E", 8);
var enemyB = new Enemy(4, 5, "E", 6);
var enemyC = new Enemy(3, 6, "W", 4);
var enemyD = new Enemy(2, 2, "E", 4);
var enemyE = new Enemy(5, 3, "W", 6);
var enemyF = new Enemy(2, 2, "E", 4);
var enemyG = new Enemy(6, 3, "W", 8);
var enemyH = new Enemy(1, 6, "E", 6);
var enemyI = new Enemy(0, 7, "E", 2);
var enemyJ = new Enemy(6, 2, "S", 6);
var enemyK = new Enemy(2, 4, "S", 8);
var enemyN = new Enemy(8, 0, "N", 4);
var enemyM = new Enemy(5, 8, "E", 4);
var enemyO = new Enemy(2, 9, "E", 4);
var enemyP = new Enemy(8, 7, "E", 6);
var enemyQ = new Enemy(7, 8, "E", 6);
...
var heartA = new PowerUp(9, 5, "Heart", 0);
var heartB = new PowerUp(1, 4, "Heart", 0);
var heartC = new PowerUp(4, 6, "Heart", 0);

var gem_bA = new PowerUp(1, 5, "Gem_Blue", 100);
var gem_bB = new PowerUp(8, 5, "Gem_Blue", 100);
var gem_gA = new PowerUp(1, 8, "Gem_Green", 50);
var gem_gB = new PowerUp(8, 8, "Gem_Green", 50);
var gem_oA = new PowerUp(1, 2, "Gem_Orange", 150);
var gem_oB = new PowerUp(8, 2, "Gem_Orange", 150);

var allPowerUps = [heartA, heartB, heartC, gem_bA, gem_bB, gem_gA, gem_gB, gem_oA, gem_oB];

//create a player at coordinate (x, y)

var player = new Player(5, 9, 50, 0);
